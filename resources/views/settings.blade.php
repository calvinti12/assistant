                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input value="{{\App\Http\Controllers\SettingsController::get('fbAppId')}}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input value="{{\App\Http\Controllers\SettingsController::get('fbAppSec')}}" type="text"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <a href="{{$loginUrl}}" class="btn btn-primary"><i class="fa fa-facebook"></i> Connect</a>
